<template>
  <aside class="ml-auto md:flex md:flex-col rounded-xl lg:w-80% lg:mt-0 mt-10 w-full relative">
    <article class="border-my-color-pale-gray border-4 rounded-2xl p-3">
      ...
      <div
        class="grid grid-cols-4 lg:grid-cols-4 md:grid-cols-5 sm:grid-cols-4 gap-4 mt-3 overflow-hidden"
      >
        <coming-soon
    ...
    <article class="border-my-color-pale-gray border-4 rounded-2xl p-3 mt-10">
      ...
      <div class="w-full">
        <button
          class="block mx-auto py-1 px-4 mt-4 border-2 border-my-color-custom-orange text-my-color-custom-orange rounded-xl hover:bg-my-color-custom-orange hover:text-black"
        >
          see more
        </button>
      </div>

<template>
  <div
    class="login-box bg-cover bg-center bg-no-repeat h-screen bg-my-color-primary-gray flex justify-center items-center"
  >
      ...
      <form @submit.prevent="sigin" class="shadow-4xl p-8 w-96 rounded-xl">
        ...
        <div class="mt-8">
          <span class="text-white"
            ...
            <a href="https://www.themoviedb.org/signup" class="underline">Sign Up</a> now</span
          >
        </div>
      </form>
    </div>
